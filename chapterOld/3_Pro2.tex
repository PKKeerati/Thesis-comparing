...
\begin{figure*}[t]
\centering
\includegraphics[width=0.75\textwidth]{FigureOld/Chapter 4/MO.jpg}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.65\textwidth]{FigureOld/Chapter 4/Acceptor.jpg}
...
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/naphthalene_J_surface.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/naphthalene_J^2_surface.jpg}
  \caption{}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/naphthalene_logJ^2_surface.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.3}
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/Representation1.jpg}
    \caption{
        \label{fig:4.4}
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/RDF_Bead.jpg}
    \caption{
        \label{fig:4.5}
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/RDF_NH.jpg}
    \caption{
        \label{fig:4.7}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/fitting_Bead_CSi_od2_td10_p19_q43_rcut136.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/fitting_NH_CSi_od2_td10_p19_q43_rcut136.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.8}
...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/od_error.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/1_Naphthalene/td_error.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.9}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/od_basis.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/td_basis.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.10}
...
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/thiophene_J_surface.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/thiophene_J^2_surface.jpg}
  \caption{}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/thiophene_logJ^2_surface.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.11}
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/Representation2.jpg}
    \caption{
        \label{fig:4.12}
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/RDF_NH.jpg}
    \caption{
        \label{fig:4.13}
...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/fitting_NH_CSi_od2_td40_p19_q43_rcut136.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/fitting_NH_CS_SiO_od2_td40_p19_q43_rcut136.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.14}
...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/od_error.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/td_error.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.16}
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=0.475\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/2_Thiophene/fitting_Bead_CSi_od2_td10_p19_q43_rcut136.jpg}
    \caption{
        \label{fig:4.17}
        Analysis of thiophene dimer RDFs and RBFs used in the ACE descriptor construction for the Heavy-atom representation.
        The upper panel shows the intra- and intermolecular RDFs as a function of pairwise distance, with a dashed line indicating the fixed centre-of-mass separation of 6~\AA.
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/4_DF_Ethylene/Representation3.jpg}
    \caption{
        \label{fig:4.18}
...
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/3_Ethylene/ethylene_J_surface.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/3_Ethylene/ethylene_J^2_surface.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/3_Ethylene/ethylene_logJ^2_surface.jpg}
  \caption{}
\end{subfigure}
...
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/4_DF_Ethylene/DFethylene_J_surface.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/4_DF_Ethylene/DFethylene_J^2_surface.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/4_DF_Ethylene/DFethylene_logJ^2_surface.jpg}
  \caption{}
\end{subfigure}
...
\begin{figure*}[t]\centering
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/4_DF_Ethylene/RDF_NH.jpg}
    \caption{
        \label{fig:4.20}
...
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/3_Ethylene/fitting_NH_CSi_od2_td10_p19_q43_rcut136.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/4_DF_Ethylene/fitting_NH_CSi_od2_td40_p19_q43_rcut136.jpg}
  \caption{}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{FigureOld/Chapter 4/4_DF_Ethylene/fitting_NH_CS_SiO_od2_td40_p19_q43_rcut136.jpg}
  \caption{}
\end{subfigure}
    \caption{
        \label{fig:4.21}
